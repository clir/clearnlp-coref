...
public class PreciseConstructMatch extends AbstractSieve{
	...
	public boolean appositiveMatch(AbstractMention prev, AbstractMention curr){
        return (curr.getNode().isLabel(DEPTagEn.DEP_APPOS) && curr.getNode().getHead() == prev.getNode());
    }

	public boolean predicateNominativeMatch(AbstractMention prev, AbstractMention curr){
	...
	public boolean acronymMatch(AbstractMention prev, AbstractMention curr){
