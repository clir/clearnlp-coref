 ...
 * @since 	Jul 2, 2015
 */
public class NYTimesCorpusParser {
	
	public static final String DIR_IN = "/Users/HenryChen/Desktop/NYTimes/world/";
	public static final String DIR_OUT = "/Users/HenryChen/Desktop/NYTimes_Parsed/world/";
	public static final String EXT = ".cnlp";
	...
	public static void main(String[] args){
		...
		List<DEPTree> trees;
		List<String> l_filePaths = FileUtils.getFileList(DIR_IN, ".com", true);
		...
		for(String filePath : l_filePaths){
			try {
				...
				while( (line = reader.readLine()) != null){
					...
					document.append(CharConst.SPACE);
				}
				reader.close();
				
				trees = decoder.toDEPTrees(document.toString());
